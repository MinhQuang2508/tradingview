...
export const DICT = {
  vi: {
    ...
    gold: {
      m:{ worldVnd:'TG quy đổi', sjcBuy:'SJC mua', sjcSell:'SJC bán', premium:'Premium', cbNet:'NHTW ròng' },
      metricTip:'Bật hoặc tắt chuỗi giá vàng',
      tableLink:'Bảng NHTW ↗',
      key:{ xau:'Vàng quốc tế', worldVnd:'Vàng TG quy đổi', sjcBuy:'SJC mua vào', sjcSell:'SJC bán ra', premium:'Chênh SJC–TG', cbNet:'NHTW mua/bán ròng' },
      unit:{ xau:'USD/oz', worldVnd:'triệu/lượng', sjcBuy:'triệu/lượng', sjcSell:'triệu/lượng', premium:'triệu/lượng', cbNet:'tấn/tháng' },
      col:{ date:'Ngày', xau:'Vàng USD/oz', world:'TG quy đổi', sell:'SJC bán', premium:'Chênh lệch', cbNet:'NHTW ròng' },
      ...
      about:{ h1:'Cách đọc',h2:'Nguồn dữ liệu',h3:'Lưu ý',
        p1:'Chart vàng độc lập gồm giá quốc tế, giá quốc tế quy đổi, giá mua/bán vàng miếng SJC, premium và lượng mua/bán ròng hằng tháng của ngân hàng trung ương.',
        p2:'Giá fix London từ LBMA, COMEX GC=F và API chính thức của SJC. Dòng NHTW lấy cùng bộ IRFCL của IMF đã làm sạch đang cấp cho bảng chi tiết.',
  ...
  en: {
    ...
    gold: {
      m:{ worldVnd:'World in VND', sjcBuy:'SJC buy', sjcSell:'SJC sell', premium:'Premium', cbNet:'CB net' },
      metricTip:'Toggle gold-price series',
      tableLink:'Central-bank table ↗',
      key:{ xau:'International gold', worldVnd:'World gold converted', sjcBuy:'SJC bid', sjcSell:'SJC ask', premium:'SJC–world premium', cbNet:'Central-bank net buying' },
      unit:{ xau:'USD/oz', worldVnd:'VND mn/tael', sjcBuy:'VND mn/tael', sjcSell:'VND mn/tael', premium:'VND mn/tael', cbNet:'tonnes/month' },
      col:{ date:'Date', xau:'XAU/USD', world:'World converted', sell:'SJC ask', premium:'Premium', cbNet:'CB net' },
      ...
      about:{ h1:'How to read',h2:'Data sources',h3:'Notes',
        p1:'A standalone gold chart with international gold, converted world price, SJC bullion, its premium, and monthly central-bank net buying.',
        p2:'London PM, COMEX GC=F and SJC’s official API supply prices. Central-bank flow uses the same cleaned IMF IRFCL dataset as the detailed table.',
